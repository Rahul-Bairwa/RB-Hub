...
<p>A full-stack e-commerce application built using the MERN stack (MongoDB, Express.js, React, Node.js). Users can browse products, manage their cart, and place orders, while admins can manage products and orders.</p>
